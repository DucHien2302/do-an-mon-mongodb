...
public class UserAccountController : Controller
{
    ...
    [HttpPost]
    public async IActionResult DeleteExperienceDetail(string jobTitle)
    {
        try
        {
            var ret = await userAccountRepository.DeleteExperienceDetailByJobTitleAsync(ObjectId.Parse(User.FindFirstValue(ClaimTypes.NameIdentifier)), jobTitle);
