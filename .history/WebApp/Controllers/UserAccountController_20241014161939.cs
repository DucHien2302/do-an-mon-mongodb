...
public class UserAccountController : Controller
{
    ...
    public IActionResult Update(UserAccount obj, IFormFile f)
    {
        ...
        UserAccount user = userAccountRepository.GetUserAccount(User.FindFirstValue(ClaimTypes.Email));
        if (user != null)
        {
            var ret = userAccountRepository.UpdateUserAccountAsync(User.FindFirstValue(ClaimTypes.NameIdentifier), obj);
        }
