...
public class UserAccountRepository
{
    ...
    public async Task<bool> UpdateUserAccountAsync(ObjectId id, UserAccount updatedUserAccount)
    {
        ...
        // Chuyển đổi ngày sinh về UTC trước khi lưu
        var dateOfBirthUtc = updatedUserAccount.DateOfBirth != default(DateTime)
            ? updatedUserAccount.DateOfBirth.ToUniversalTime() // Chuyển sang UTC
        ...
        {
            // Chuyển đổi DateOfBirth từ UTC về giờ địa phương để hiển thị
            updatedAccount.DateOfBirth = updatedAccount.DateOfBirth.ToLocalTime();
