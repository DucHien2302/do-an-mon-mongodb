...
public class UserAccountRepository
{
    ...
    public async Task UpdateUserAccountByIdAsync(ObjectId id, UserAccount updatedUserAccount)
    {
        ...
        var update = Builders<UserAccount>.Update
            ...
            .Set(u => u.RegistrationDate, updatedUserAccount.RegistrationDate)
        ...
        var collection = connection.GetCollection<UserAccount>("user_accoutn");
        await connection.UpdateOneAsync(filter, update);
    }
}