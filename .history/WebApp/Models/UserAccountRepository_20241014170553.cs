...
public class UserAccountRepository
{
    ...
    public async Task<bool> UpdateUserAccountAsync(ObjectId id, UserAccount updatedUserAccount)
    {
        ...
        var update = Builders<UserAccount>.Update
            ...
            .Set(u => u.Password, string.IsNullOrEmpty(updatedUserAccount.Password) ? updatedUserAccount.Password : Helper.HashPassword(updatedUserAccount.Password))
            ...
            .Set(u => u.IsActive, updatedUserAccount.IsActive) // Ensure IsActive is updated
